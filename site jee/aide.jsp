<%@ page import="com.example.site_jee.Ville" %>
          ...
          <div class="item3">
              <div class="form-style-2">
                  ...
                  <form action="" method="post">
                      ...
                      <label ><span>Longitude <span class="required">*</span></span><input type="text" name="longitude" class="input-field"></label>
                      <label ><span>Latitude <span class="required">*</span></span><input type="text" name="latitude" class="input-field"></label>
