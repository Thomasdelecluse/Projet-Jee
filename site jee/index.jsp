<%@ page import="com.example.site_jee.Hero" %>
            ...
            <div class="item1">
                ...
                <div class="display">
                    <a href="/Site_jee-1.0-SNAPSHOT/hero" class="HOVER">
                        <span></span>
                        <text><i class="fas fa-mask"></i>&nbsp; &nbsp; Hero</text>
                    </a>
            ...
            <div class="item3">
                <div class="form-style-2">
                    ...
                    <form action="" method="post" enctype="multipart/form-data">
                        ...
                        <label ><span>Incident Maitriser 1</span><select name="incident1" class="select-field">
                        ...
                        <label><span>Telephone <span class="required">*</span></span><input type="text" class="tel-number-field" name="tel" value="" maxlength="2" />-<input type="text" class="tel-number-field" name="tel_no_2" value="" maxlength="2"  />-<input type="text" class="tel-number-field" name="tel_no_3" value="" maxlength="2"  />-<input type="text" class="tel-number-field" name="tel_no_3" value="" maxlength="2"  />-<input type="text" class="tel-number-field" name="tel_no_3" value="" maxlength="2"  /></label>
                        ...
                        <label ><span>Longitude <span class="required">*</span></span><input type="number" step=".0001" name="longitude" class="input-field"></label>
                        <label ><span>Latitude <span class="required">*</span></span><input type="number" step=".0001" name="latitude" class="input-field"></label>
